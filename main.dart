...
class _HomeState extends State<Home> {
  final List<Cart> _carts = [
    Cart(id: 'DW1', title: 'Pensil', nama: 'Agus ', harga: 2000, qty: 10),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Sanjaya Store"),
        actions: <Widget>[
          FlatButton(child: Icon(Icons.clear, color: Colors.black,), onPressed: () => _resetCarts(),
          ),
